...
public class CharacterPhysics : MonoBehaviour
{
    ...
    public RaycastHit PreviousGroundHitInfo { get; private set; }
    ...
    public void UpdatePhysics()
    {
        ...
        Physics.BoxCast(center, size, Vector3.down, out RaycastHit hitInfo, this.CharacterController.transform.rotation, _collisionBoxHeight);
